...
public enum IsaErrorMessage {
    ...
    PLUGIN_NYI_2P(VDM2IsaError.ISABELLE_PLUGIN_BASE + 0, 
    "Not yet implemented %1$s for %2$s"),
    PLUGIN_MISSING_MAPPING_ERROR_2P(VDM2IsaError.ISABELLE_PLUGIN_BASE + 1,
    "Cannot yet convert %1$s = %2$s"),
    PLUGIN_UNEXPECTED_ERROR_2P(VDM2IsaError.ISABELLE_PLUGIN_BASE + 2,
    ...
    VDMSL_VDM10_ONLY        (VDM2IsaError.ISABELLE_VDMSL_BASE + 0, 
    "Only VDMSL supports Isabelle translation."),
    VDMSL_INVALID_PATTERN   (VDM2IsaError.ISABELLE_VDMSL_BASE + 1, 
    "Invalid empty bind pattern list."),
    VDMSL_INVALID_PATTERN_BIND(VDM2IsaError.ISABELLE_VDMSL_BASE + 2, 
    "Cannot have null pattern and bind in TRPatternBind"),
    VDMSL_FIELD_MISSING_RECORDTYPE_1P(VDM2IsaError.ISABELLE_VDMSL_BASE + 3, 
    "Field %1$s does not have its record type set."),
    VDMSL_INVALID_SPECIFICATION_1P(VDM2IsaError.ISABELLE_VDMSL_BASE + 4,
    "Explicit funciton has declared %1$s but no definition AST."),
    VDMSL_INVALID_CURRIED_FCNTYPE_2P(VDM2IsaError.ISABELLE_VDMSL_BASE + 5,
    "Inconsistent curried function declaration \"%1$s\": intermediate result does not have function type - %2$s"),
    VDMSL_INVALID_EXPR_4P(VDM2IsaError.ISABELLE_VDMSL_BASE + 6,
    "Invalid %1$s arguments for \"%2$s\" length(%3$s) = %4$s."),
    VDMSL_INVALID_TUPLE_TYPE_3P(VDM2IsaError.ISABELLE_VDMSL_BASE + 7, 
    "Invalid type for tuple projection expression %1$s.#%2$s = %3$s"),
    VDMSL_INVALID_TUPLE_PROJECTION_3P(VDM2IsaError.ISABELLE_VDMSL_BASE + 8,
    "Invalid tuple projection field (%1$s) is bigger than tuple size (%2$s)."), 
    VDMSL_INVALID_MKARGS_3P(VDM2IsaError.ISABELLE_VDMSL_BASE + 9,
    "Invalid record arguments: incompatible number of fields for VDM mk_%1$s expression. Found %2$s, expected %3$s."),
    VDMSL_INVALID_TESTEXPR_2P(VDM2IsaError.ISABELLE_VDMSL_BASE + 10,
    ...
    {
        assert number >= VDM2IsaError.ISABELLE_PLUGIN_BASE;
        this.number = number;
