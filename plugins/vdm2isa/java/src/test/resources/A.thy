(* VDM to Isabelle Translation @2021-12-12T11:08:39.404268Z
...
\<comment>\<open>in 'A' (./src/test/resources/TestV2IModules.vdmsl) at line 9:5\<close>
abbreviation
	v :: "VDMNat"
where
	"v \<equiv> (10::VDMNat1)"
...
\<comment>\<open>in 'A' (./src/test/resources/TestV2IModules.vdmsl) at line 10:5\<close>
abbreviation
	p :: "VDMNat"
where
	"p \<equiv> (10::VDMNat1)"
...
\<comment>\<open>VDM source: T = nat
	inv t == (t > v)\<close>
\<comment>\<open>in 'A' (./src/test/resources/TestV2IModules.vdmsl) at line 12:5\<close>
...
\<comment>\<open>VDM source: inv_T: (nat +> bool)
	inv_T(t) ==
(t > v)\<close>
\<comment>\<open>in 'A' (./src/test/resources/TestV2IModules.vdmsl) at line 12:17\<close>
definition
...
\<comment>\<open>VDM source: S = nat
	inv s == (s < v)\<close>
\<comment>\<open>in 'A' (./src/test/resources/TestV2IModules.vdmsl) at line 13:5\<close>
...
\<comment>\<open>VDM source: inv_S: (nat +> bool)
	inv_S(s) ==
(s < v)\<close>
\<comment>\<open>in 'A' (./src/test/resources/TestV2IModules.vdmsl) at line 13:17\<close>
definition
...
\<comment>\<open>VDM source: Q = nat
	inv q == (q > 0)\<close>
\<comment>\<open>in 'A' (./src/test/resources/TestV2IModules.vdmsl) at line 14:5\<close>
...
\<comment>\<open>VDM source: inv_Q: (nat +> bool)
	inv_Q(q) ==
(q > 0)\<close>
\<comment>\<open>in 'A' (./src/test/resources/TestV2IModules.vdmsl) at line 14:17\<close>
definition
...
\<comment>\<open>VDM source: f: (nat -> nat)
	f(a) ==
(a + 1)\<close>
\<comment>\<open>in 'A' (./src/test/resources/TestV2IModules.vdmsl) at line 16:5\<close>
...
\<comment>\<open>VDM source: h: (nat -> nat)
	h(a) ==
a\<close>
\<comment>\<open>in 'A' (./src/test/resources/TestV2IModules.vdmsl) at line 21:5\<close>
