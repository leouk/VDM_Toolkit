(* VDM to Isabelle Translation @2021-11-28T11:15:11.880815Z
...
\<comment>\<open>in 'TestV2ITypesUnion' (./src/test/resources/TestV2ITypesUnion.vdmsl) at line 6:5\<close>
...
\<comment>\<open>in 'TestV2ITypesUnion' (./src/test/resources/TestV2ITypesUnion.vdmsl) at line 9:9\<close>
definition
	...
	(case u2 of
      ...
      (case u6 of
          TUnion6.U_VDMInt u6 \<Rightarrow> 
              ((isTest (u6) (inv_VDMInt) \<longrightarrow> 
                  ( (isTest (u2) (inv_VDMSeq' (inv_VDMNat)) \<longrightarrow> (u6 \<in> (elems u2)))  
                   \<comment> \<open> \<and> (isTest (u2) (inv_VDMSet' (inv_VDMReal)) \<longrightarrow> (u6 \<in> u2)) \<close>
                  )
                ) \<and> 
              (isTest (u6) (inv_VDMNat) \<longrightarrow> 
                  ( (isTest (u2) (inv_VDMSeq' (inv_VDMNat)) \<longrightarrow> (\<not> (u6 \<in> (elems u2)))) 
                    \<comment> \<open> \<and> (isTest (u2) (inv_VDMSet' (inv_VDMReal)) \<longrightarrow> (\<not> (u6 \<in> u2))) \<close>
                  )
              ))
       )
      ...
      (case u6 of
            TUnion6.U_VDMInt u6 \<Rightarrow> 
              ((isTest (u6) (inv_VDMInt) \<longrightarrow> 
                  ( \<comment> \<open>(isTest (u2) (inv_VDMSeq' (inv_VDMNat)) \<longrightarrow> (u6 \<in> (elems u2))) \<and> \<close>
                   (isTest (u2) (inv_VDMSet' (inv_VDMReal)) \<longrightarrow> (u6 \<in> u2))
                  )) 
                  \<and> 
               (isTest (u6) (inv_VDMNat) \<longrightarrow> 
                  ( \<comment> \<open>(isTest (u2) (inv_VDMSeq' (inv_VDMNat)) \<longrightarrow> (\<not> (u6 \<in> (elems u2)))) \<and>\<close> 
                   (isTest (u2) (inv_VDMSet' (inv_VDMReal)) \<longrightarrow> (\<not> (u6 \<in> u2))))
                 ))
           )
		 ))"

	
\<comment>\<open>in 'TestV2ITypesUnion' (./src/test/resources/TestV2ITypesUnion.vdmsl) at line 32:5\<close>
