...
VDM po: R: invariant satisfiability obligation in 'TestV2I' (./src/test/resources/TestV2I.vdmsl) at line 7:5
exists r : R & ((r.x) < (r.y))

\<close>theorem R_INV_SATISFIABILITY:
	"((\<exists> (r::R). ((x\<^sub>R (r)) < (y\<^sub>R (r)))))"
	
	try
	by (metis gt_ex select_convs(1) select_convs(2))
	oops
	
	\<comment>\<open>@ in 'TestV2I' (./src/test/resources/TestV2I.vdmsl) at line 18:15
VDM po: mkr: subtype obligation in 'TestV2I' (./src/test/resources/TestV2I.vdmsl) at line 18:15
(forall n:nat &
  inv_R(mk_R(n, (n + 1))))

\<close>theorem mkr_SUB_TYPE:
...
VDM po: t11: subtype obligation in 'TestV2I' (./src/test/resources/TestV2I.vdmsl) at line 37:25
{1, ... ,5} <> {} and is_({1, ... ,5}, set1 of (nat1))

\<close>theorem t11_SUB_TYPE:
...
VDM po: t14: map sequence compatible obligation in 'TestV2I' (./src/test/resources/TestV2I.vdmsl) at line 40:29
forall m1, m2 in set {{1 |-> 1}, {2 |-> 3}} & forall d3 in set dom m1, d4 in set dom m2 & d3 = d4 => m1(d3) = m2(d4)

\<close>theorem t14_MAP_SEQ_OF_COMPATIBLE:
...
VDM po: v9: non-empty set obligation in 'TestV2I' (./src/test/resources/TestV2I.vdmsl) at line 52:17
t12 <> {}

\<close>theorem v9_NON_EMPTY_SET:
	"((t12 \<noteq> {}))"
...
VDM po: v19: map set compatible obligation in 'TestV2I' (./src/test/resources/TestV2I.vdmsl) at line 62:16
forall m1, m2 in set {t14, t15} & forall d3 in set dom m1, d4 in set dom m2 & d3 = d4 => m1(d3) = m2(d4)

\<close>theorem v19_MAP_SET_OF_COMPATIBLE:
...
VDM po: v22: type invariant obligation in 'TestV2I' (./src/test/resources/TestV2I.vdmsl) at line 65:10
is_(t14, inmap nat1 to nat1)

\<close>theorem v22_INVARIANT:
	"(not yet)"
...
VDM po: v44: map compatible obligation in 'TestV2I' (./src/test/resources/TestV2I.vdmsl) at line 87:10
forall ldom1 in set dom t14, rdom2 in set dom t15 & ldom1 = rdom2 => t14(ldom1) = t15(rdom2)

\<close>theorem v44_MAP_COMPATIBLE:
...
VDM po: v45: map compose obligation in 'TestV2I' (./src/test/resources/TestV2I.vdmsl) at line 88:14
rng(t15) subset dom(t14)

\<close>theorem v45_MAP_COMPOSE:
...
VDM po: v61: map sequence compatible obligation in 'TestV2I' (./src/test/resources/TestV2I.vdmsl) at line 104:10
forall m1, m2 in set {{1 |-> 2}, {2 |-> 3}} & forall d3 in set dom m1, d4 in set dom m2 & d3 = d4 => m1(d3) = m2(d4)

\<close>theorem v61_MAP_SEQ_OF_COMPATIBLE:
...
VDM po: v65: subtype obligation in 'TestV2I' (./src/test/resources/TestV2I.vdmsl) at line 111:14
inv_R(mk_R(1, 2))

\<close>theorem v65_SUB_TYPE:
...
VDM po: v651: subtype obligation in 'TestV2I' (./src/test/resources/TestV2I.vdmsl) at line 112:12
inv_R(mk_R(1, 2))

\<close>theorem v651_SUB_TYPE:
	"((inv_R \<lparr>x\<^sub>R = (1::VDMNat1), y\<^sub>R = (2::VDMNat1)\<rparr>))"
...
VDM po: v722: subtype obligation in 'TestV2I' (./src/test/resources/TestV2I.vdmsl) at line 124:39
(let r:real = 4.0 in
  is_nat1(r))

\<close>theorem v722_SUB_TYPE:
	"((
		let (r::VDMReal) = (4.0)
		in
...
VDM po: v723: subtype obligation in 'TestV2I' (./src/test/resources/TestV2I.vdmsl) at line 125:20
is_nat1((6 / 2))

\<close>theorem v723_SUB_TYPE:
	"(not yet)"
...
VDM po: v73: unique existence binding obligation in 'TestV2I' (./src/test/resources/TestV2I.vdmsl) at line 126:11
exists1 var in set t9 & (var < 2)

\<close>theorem v73_UNIQUE_EXISTENCE:
