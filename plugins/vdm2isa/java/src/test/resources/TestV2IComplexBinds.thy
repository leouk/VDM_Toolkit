(* VDM to Isabelle Translation @2021-11-18T10:53:22.713791Z
...
\<comment>\<open>in 'TestV2IComplexBinds' (./src/test/resources/TestV2IComplexBinds.vdmsl) at line 7:9\<close>
definition
...
where
	"v2 \<equiv> (
		let 
(x::VDMNat1) = fst ((1::VDMNat1), (2::VDMNat1));
(y::VDMNat1) = snd ((1::VDMNat1), (2::VDMNat1))
		in
			(if (
		((inv_VDMNat1 x )\<and>
		 (inv_VDMNat1 y )
