(* VDM to Isabelle Translation @2021-12-22T07:31:21.425665Z
   Copyright 2021, Leo Freitas, leo.freitas@newcastle.ac.uk

in './src/test/resources/TestV2IExprsSpecial.vdmsl' at line 1:8
files = [./src/test/resources/TestV2IExprsSpecial.vdmsl]
*)
...
\<comment>\<open>in 'TestV2IExprsSpecial' (./src/test/resources/TestV2IExprsSpecial.vdmsl) at line 5:5\<close>
record V = 
	x\<^sub>V :: "VDMNat"
...
\<comment>\<open>in 'TestV2IExprsSpecial' (./src/test/resources/TestV2IExprsSpecial.vdmsl) at line 6:5\<close>
...
\<comment>\<open>in 'TestV2IExprsSpecial' (./src/test/resources/TestV2IExprsSpecial.vdmsl) at line 7:5\<close>
...
\<comment>\<open>in 'TestV2IExprsSpecial' (./src/test/resources/TestV2IExprsSpecial.vdmsl) at line 9:5\<close>
...
\<comment>\<open>in 'TestV2IExprsSpecial' (./src/test/resources/TestV2IExprsSpecial.vdmsl) at line 10:5\<close>
record T = 
	u\<^sub>T :: "U"
...
\<comment>\<open>in 'TestV2IExprsSpecial' (./src/test/resources/TestV2IExprsSpecial.vdmsl) at line 11:5\<close>
...
\<comment>\<open>in 'TestV2IExprsSpecial' (./src/test/resources/TestV2IExprsSpecial.vdmsl) at line 13:5\<close>
record Q = 
	p\<^sub>Q :: "P"
...
\<comment>\<open>VDM source: f: (nat -> nat)
	f(x) ==
(x + 1)\<close>
\<comment>\<open>in 'TestV2IExprsSpecial' (./src/test/resources/TestV2IExprsSpecial.vdmsl) at line 17:5\<close>
...
\<comment>\<open>in 'TestV2IExprsSpecial' (./src/test/resources/TestV2IExprsSpecial.vdmsl) at line 21:5\<close>

\<comment>\<open>VDM source: pre_g: (M * N +> bool)
	pre_g(m, n) ==
(n in set (dom m))\<close>
\<comment>\<open>in 'TestV2IExprsSpecial' (./src/test/resources/TestV2IExprsSpecial.vdmsl) at line 23:11\<close>
definition
...
let r:V = m(n) in ((r.x) + n)
	pre (n in set (dom m))\<close>
\<comment>\<open>in 'TestV2IExprsSpecial' (./src/test/resources/TestV2IExprsSpecial.vdmsl) at line 26:5\<close>

\<comment>\<open>VDM source: pre_g': (M * N +> bool)
	pre_g'(m, n) ==
(n in set (dom m))\<close>
\<comment>\<open>in 'TestV2IExprsSpecial' (./src/test/resources/TestV2IExprsSpecial.vdmsl) at line 28:11\<close>
definition
	pre_g' :: "M\<Rightarrow> N \<Rightarrow> bool"
where
	"pre_g' m  n \<equiv> 
...
\<comment>\<open>VDM source: h: (P * N -> P)
	h(p, n) ==
(p ++ {n |-> mk_T(n)})\<close>
\<comment>\<open>in 'TestV2IExprsSpecial' (./src/test/resources/TestV2IExprsSpecial.vdmsl) at line 31:5\<close>
...
where
	...
	(p \<dagger> [n\<mapsto>\<lparr>u\<^sub>T = n\<rparr>])"

	
\<comment>\<open>VDM source: q: (Q * N -> Q)
	q(q0, n) ==
mu(q0, p |-> h((q0.p), n))\<close>
\<comment>\<open>in 'TestV2IExprsSpecial' (./src/test/resources/TestV2IExprsSpecial.vdmsl) at line 35:5\<close>
...
\<comment>\<open>in 'TestV2IExprsSpecial' (./src/test/resources/TestV2IExprsSpecial.vdmsl) at line 40:5\<close>
abbreviation
	v1 :: "VDMNat"
where
	"v1 \<equiv> (
...
\<comment>\<open>in 'TestV2IExprsSpecial' (./src/test/resources/TestV2IExprsSpecial.vdmsl) at line 42:5\<close>
abbreviation
	v2 :: "VDMNat"
where
	"v2 \<equiv> (
