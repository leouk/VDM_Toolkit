...
\begin{enumerate}
    ...
    \item Measurement systems and operators (\texti{e.g.}~group of dimensions like BSI or SI); 
...
%         \bottomrule
%     \end{tabular}
%     \caption{Standard measurement system (SI) base quantities of measurement}\label{tbl:SICombined}
% \end{table} 
