...
\gls{ISQ} has conventions corresponding to measurement-quantity category, abbreviations, dimensions and common names listed in~\Cref{tbl:SI}. Further background on ISQ itself is given in context of their corresponding definitions within the VDM library description.  
%
\begin{table}[htbp]
    \centering
    \begin{tabular}{lccll}
