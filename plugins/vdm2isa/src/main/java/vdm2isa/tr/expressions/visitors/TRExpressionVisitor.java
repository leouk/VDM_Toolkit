...
import vdm2isa.tr.statements.TRAssignmentStatement;
import vdm2isa.tr.statements.TRBlockStatement;
import vdm2isa.tr.statements.TRFieldDesignator;
import vdm2isa.tr.statements.TRIdentifierDesignator;
import vdm2isa.tr.statements.TRStateDesignator;
...
public abstract class TRExpressionVisitor<R, S>
{
	...
	public R casePreOpExpression(TRPreOpExpression node, S arg) {
		return caseExpression(node, arg);
	}
