(* VDM to Isabelle Translation @2022-05-26T11:45:34.969Z
   Copyright 2021, Leo Freitas, leo.freitas@newcastle.ac.uk

in '/Users/nljsf/Local/reps/git/VDM_Toolkit/plugins/vdm2isa/src/test/resources/TestV2IFcns.vdmsl' at line 1:8
...
\<comment>\<open>VDM source: const: (() -> nat)
	const() ==
10\<close>
\<comment>\<open>in 'TestV2IFcns' (/Users/nljsf/Local/reps/git/VDM_Toolkit/plugins/vdm2isa/src/test/resources/TestV2IFcns.vdmsl) at line 8:5\<close>
...
\<comment>\<open>VDM source: pre_constS: (() +> bool)
	pre_constS() ==
(10 > 5)\<close>
\<comment>\<open>in 'TestV2IFcns' (/Users/nljsf/Local/reps/git/VDM_Toolkit/plugins/vdm2isa/src/test/resources/TestV2IFcns.vdmsl) at line 14:12\<close>
definition
	pre_constS :: "bool"
where
	"pre_constS  \<equiv> 
...
\<comment>\<open>VDM source: post_constS: (nat +> bool)
	post_constS(RESULT) ==
(RESULT > 0)\<close>
\<comment>\<open>in 'TestV2IFcns' (/Users/nljsf/Local/reps/git/VDM_Toolkit/plugins/vdm2isa/src/test/resources/TestV2IFcns.vdmsl) at line 15:17\<close>
definition
...
\<comment>\<open>VDM source: f: (nat * nat1 -> nat1)
	f(x, y) ==
(x + y)\<close>
\<comment>\<open>in 'TestV2IFcns' (/Users/nljsf/Local/reps/git/VDM_Toolkit/plugins/vdm2isa/src/test/resources/TestV2IFcns.vdmsl) at line 18:5\<close>
...
\<comment>\<open>VDM source: pre_g: (nat * nat1 +> bool)
	pre_g(x, y) ==
(x > 10)\<close>
\<comment>\<open>in 'TestV2IFcns' (/Users/nljsf/Local/reps/git/VDM_Toolkit/plugins/vdm2isa/src/test/resources/TestV2IFcns.vdmsl) at line 24:11\<close>
definition
...
\<comment>\<open>VDM source: post_g: (nat * nat1 * nat1 +> bool)
	post_g(x, y, RESULT) ==
(x < RESULT)\<close>
\<comment>\<open>in 'TestV2IFcns' (/Users/nljsf/Local/reps/git/VDM_Toolkit/plugins/vdm2isa/src/test/resources/TestV2IFcns.vdmsl) at line 25:12\<close>
definition
...
\<comment>\<open>VDM source: pre_h: (nat +> bool)
	pre_h(x) ==
pre_g(x, x)\<close>
\<comment>\<open>in 'TestV2IFcns' (/Users/nljsf/Local/reps/git/VDM_Toolkit/plugins/vdm2isa/src/test/resources/TestV2IFcns.vdmsl) at line 30:9\<close>
definition
...
\<comment>\<open>in 'TestV2IFcns' (/Users/nljsf/Local/reps/git/VDM_Toolkit/plugins/vdm2isa/src/test/resources/TestV2IFcns.vdmsl) at line 31:10\<close>
definition
...
\<comment>\<open>VDM source: pre_h': (nat +> bool)
	pre_h'(x) ==
(x < 20)\<close>
\<comment>\<open>in 'TestV2IFcns' (/Users/nljsf/Local/reps/git/VDM_Toolkit/plugins/vdm2isa/src/test/resources/TestV2IFcns.vdmsl) at line 36:11\<close>
definition
	pre_h' :: "VDMNat \<Rightarrow> bool"
where
	"pre_h' x \<equiv> 
...
\<comment>\<open>VDM source: post_h': (nat * nat +> bool)
	post_h'(x, RESULT) ==
(x > 20)\<close>
\<comment>\<open>in 'TestV2IFcns' (/Users/nljsf/Local/reps/git/VDM_Toolkit/plugins/vdm2isa/src/test/resources/TestV2IFcns.vdmsl) at line 37:12\<close>
definition
	post_h' :: "VDMNat \<Rightarrow> VDMNat \<Rightarrow> bool"
where
	"post_h' x   RESULT \<equiv> 
...
\<comment>\<open>VDM source: pre_h'': (nat +> bool)
	pre_h''(x) ==
(x < 20)\<close>
\<comment>\<open>in 'TestV2IFcns' (/Users/nljsf/Local/reps/git/VDM_Toolkit/plugins/vdm2isa/src/test/resources/TestV2IFcns.vdmsl) at line 42:11\<close>
definition
	pre_h'' :: "VDMNat \<Rightarrow> bool"
where
	"pre_h'' x \<equiv> 
...
\<comment>\<open>in 'TestV2IFcns' (/Users/nljsf/Local/reps/git/VDM_Toolkit/plugins/vdm2isa/src/test/resources/TestV2IFcns.vdmsl) at line 43:10\<close>
definition
	post_h'' :: "VDMNat \<Rightarrow> VDMNat \<Rightarrow> bool"
where
	"post_h'' x   RESULT \<equiv> 
...
\<comment>\<open>VDM source: curried: (nat -> (nat -> nat))
	curried(x)(y) ==
(x + y)\<close>
\<comment>\<open>in 'TestV2IFcns' (/Users/nljsf/Local/reps/git/VDM_Toolkit/plugins/vdm2isa/src/test/resources/TestV2IFcns.vdmsl) at line 46:5\<close>
...
\<comment>\<open>VDM source: pre_curriedS: (nat +> (nat +> bool))
	pre_curriedS(x)(y) ==
(x > y)\<close>
\<comment>\<open>in 'TestV2IFcns' (/Users/nljsf/Local/reps/git/VDM_Toolkit/plugins/vdm2isa/src/test/resources/TestV2IFcns.vdmsl) at line 52:11\<close>
definition
...
\<comment>\<open>in 'TestV2IFcns' (/Users/nljsf/Local/reps/git/VDM_Toolkit/plugins/vdm2isa/src/test/resources/TestV2IFcns.vdmsl) at line 53:21\<close>
definition
...
(x > (len r))\<close>
\<comment>\<open>in 'TestV2IFcns' (/Users/nljsf/Local/reps/git/VDM_Toolkit/plugins/vdm2isa/src/test/resources/TestV2IFcns.vdmsl) at line 57:12\<close>
definition
...
(x > (len r))\<close>
\<comment>\<open>in 'TestV2IFcns' (/Users/nljsf/Local/reps/git/VDM_Toolkit/plugins/vdm2isa/src/test/resources/TestV2IFcns.vdmsl) at line 62:12\<close>
definition
