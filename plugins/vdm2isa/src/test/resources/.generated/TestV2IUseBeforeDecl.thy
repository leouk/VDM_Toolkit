(* VDM to Isabelle Translation @2022-12-21T07:58:32.097Z  
   Copyright 2019-22, Leo Freitas, leo.freitas@newcastle.ac.uk

   VDM translation of module TestV2IUseBeforeDecl
   in 'TestV2IUseBeforeDecl.vdmsl' at line 1:8
   files = [TestV2IUseBeforeDecl.vdmsl]
*)
...
\<comment>\<open>VDM source: tail: (seq1 of (nat) -> seq of (nat))
	tail(s) ==
(tl s)\<close>
\<comment>\<open>in 'TestV2IUseBeforeDecl' (TestV2IUseBeforeDecl.vdmsl) at line 35:5\<close>
...
(hd s)
	pre ((len s) > 0)\<close>
\<comment>\<open>in 'TestV2IUseBeforeDecl' (TestV2IUseBeforeDecl.vdmsl) at line 42:5\<close>
\<comment>\<open>VDM source: pre_head: (seq of (nat) +> bool)
	pre_head(s) ==
((len s) > 0)\<close>
\<comment>\<open>in 'TestV2IUseBeforeDecl' (TestV2IUseBeforeDecl.vdmsl) at line 44:15\<close>
definition
...
\<comment>\<open>in 'TestV2IUseBeforeDecl' (TestV2IUseBeforeDecl.vdmsl) at line 30:5\<close>
...
then 0
	...
	measure (len s)\<close>
\<comment>\<open>in 'TestV2IUseBeforeDecl' (TestV2IUseBeforeDecl.vdmsl) at line 38:5\<close>
...
\<comment>\<open>in 'TestV2IUseBeforeDecl' (TestV2IUseBeforeDecl.vdmsl) at line 24:5\<close>
type_synonym S = \<open>T\<close>
	
\<comment>\<open>VDM source: inv_S: (T +> bool)
	inv_S(s) ==
((len tail(s)) > 0)\<close>
\<comment>\<open>in 'TestV2IUseBeforeDecl' (TestV2IUseBeforeDecl.vdmsl) at line 27:21\<close>
definition
...
\<comment>\<open>in 'TestV2IUseBeforeDecl' (TestV2IUseBeforeDecl.vdmsl) at line 18:5\<close>
type_synonym R = \<open>S\<close>
	
\<comment>\<open>VDM source: inv_R: (S +> bool)
	inv_R(r) ==
(sum_elems(r) < 5)\<close>
\<comment>\<open>in 'TestV2IUseBeforeDecl' (TestV2IUseBeforeDecl.vdmsl) at line 21:22\<close>
definition
...
\<comment>\<open>in 'TestV2IUseBeforeDecl' (TestV2IUseBeforeDecl.vdmsl) at line 10:5\<close>
record Rec = 
...
\<comment>\<open>in 'TestV2IUseBeforeDecl' (TestV2IUseBeforeDecl.vdmsl) at line 15:37\<close>
definition
...
\<comment>\<open>VDM source: Map = map (S) to (Rec)
	inv m == ((dom m) = {})\<close>
\<comment>\<open>in 'TestV2IUseBeforeDecl' (TestV2IUseBeforeDecl.vdmsl) at line 6:5\<close>
type_synonym Map = \<open>(S \<rightharpoonup> Rec)\<close>
	
\<comment>\<open>VDM source: inv_Map: (map (S) to (Rec) +> bool)
	inv_Map(m) ==
((dom m) = {})\<close>
\<comment>\<open>in 'TestV2IUseBeforeDecl' (TestV2IUseBeforeDecl.vdmsl) at line 7:20\<close>
definition
