...
\<comment>\<open>in 'TestV2IOperator' (./src/test/resources/TestV2IOperation.vdmsl) at line 5:7\<close>
...
\<comment>\<open>VDM source: inv_S: (S +> bool)
	inv_S(mk_S(x, y)) ==
((x > 15) and (y < 5))\<close>
\<comment>\<open>in 'TestV2IOperator' (./src/test/resources/TestV2IOperation.vdmsl) at line 8:25\<close>
definition
...
\<comment>\<open>VDM source: init_S: (S -> bool)
	init_S ==
mk_S(25, 0)\<close>
\<comment>\<open>in 'TestV2IOperator' (./src/test/resources/TestV2IOperation.vdmsl) at line 9:13\<close>
definition
	init_S :: "S"
where
	"init_S  \<equiv> 
...
x := (x + inc)
	...
	pre ((inc < 10) and (x > 0))
	post (x < x)\<close>
\<comment>\<open>in 'TestV2IOperator' (./src/test/resources/TestV2IOperation.vdmsl) at line 14:1\<close>

\<comment>\<open>VDM source: pre_Explicit: (nat1 * S +> bool)
	pre_Explicit(inc, S) ==
((inc < 10) and (x > 0))\<close>
\<comment>\<open>in 'TestV2IOperator' (./src/test/resources/TestV2IOperation.vdmsl) at line 17:15\<close>
definition
...
(x < x)\<close>
\<comment>\<open>in 'TestV2IOperator' (./src/test/resources/TestV2IOperation.vdmsl) at line 18:10\<close>
definition
...
\<comment>\<open>VDM source: Implicit((M, A:real))
	pre ((M > 0) and (A > 0))
	post (((y - A) / M) = y)\<close>
\<comment>\<open>in 'TestV2IOperator' (./src/test/resources/TestV2IOperation.vdmsl) at line 25:1\<close>

\<comment>\<open>VDM source: pre_Implicit: (real * real * S +> bool)
	pre_Implicit(M, A, S) ==
((M > 0) and (A > 0))\<close>
\<comment>\<open>in 'TestV2IOperator' (./src/test/resources/TestV2IOperation.vdmsl) at line 27:11\<close>
definition
...
(((y - A) / M) = y)\<close>
\<comment>\<open>in 'TestV2IOperator' (./src/test/resources/TestV2IOperation.vdmsl) at line 28:16\<close>
definition
...
\<comment>\<open>VDM source: Implicit_no_body((M, A:real))
	pre ((M > 0) and (A > 0))
	post (((y - A) / M) = y)\<close>
\<comment>\<open>in 'TestV2IOperator' (./src/test/resources/TestV2IOperation.vdmsl) at line 30:1\<close>

\<comment>\<open>VDM source: pre_Implicit_no_body: (real * real * S +> bool)
	pre_Implicit_no_body(M, A, S) ==
((M > 0) and (A > 0))\<close>
\<comment>\<open>in 'TestV2IOperator' (./src/test/resources/TestV2IOperation.vdmsl) at line 31:11\<close>
definition
...
(((y - A) / M) = y)\<close>
\<comment>\<open>in 'TestV2IOperator' (./src/test/resources/TestV2IOperation.vdmsl) at line 32:16\<close>
definition
...
\<comment>\<open>in 'TestV2IOperator' (./src/test/resources/TestV2IOperation.vdmsl) at line 34:1\<close>

\<comment>\<open>VDM source: pre_Implicit_return: (real * real * S +> bool)
	pre_Implicit_return(M, A, S) ==
((M > 0) and (A > 0))\<close>
\<comment>\<open>in 'TestV2IOperator' (./src/test/resources/TestV2IOperation.vdmsl) at line 35:11\<close>
definition
...
\<comment>\<open>in 'TestV2IOperator' (./src/test/resources/TestV2IOperation.vdmsl) at line 36:21\<close>
definition
