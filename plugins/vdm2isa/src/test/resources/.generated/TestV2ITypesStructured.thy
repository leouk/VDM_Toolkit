(* VDM to Isabelle Translation @2022-12-21T08:39:44.346Z  
   Copyright 2019-22, Leo Freitas, leo.freitas@newcastle.ac.uk

   VDM translation of module TestV2ITypesStructured
   in 'TestV2ITypesStructured.vdmsl' at line 1:8
   files = [TestV2ITypesStructured.vdmsl]
*)
...
\<comment>\<open>in 'TestV2ITypesStructured' (TestV2ITypesStructured.vdmsl) at line 10:5\<close>
type_synonym G2 = \<open>(VDMInt \<times> VDMInt)\<close>
	
\<comment>\<open>VDM source: inv_G2: ((int * int) +> bool)
	inv_G2(mk_(l, r)) ==
(l < r)\<close>
\<comment>\<open>in 'TestV2ITypesStructured' (TestV2ITypesStructured.vdmsl) at line 11:23\<close>
definition
...
\<comment>\<open>VDM source: G2' = (int * int)
	inv g == ((g.#1) < (g.#2))\<close>
\<comment>\<open>in 'TestV2ITypesStructured' (TestV2ITypesStructured.vdmsl) at line 14:5\<close>
type_synonym G2' = \<open>(VDMInt \<times> VDMInt)\<close>
	
\<comment>\<open>VDM source: inv_G2': ((int * int) +> bool)
	inv_G2'(g) ==
((g.#1) < (g.#2))\<close>
\<comment>\<open>in 'TestV2ITypesStructured' (TestV2ITypesStructured.vdmsl) at line 15:19\<close>
definition
	inv_G2' :: \<open>G2' \<Rightarrow> bool\<close>
where
	\<open>inv_G2' g \<equiv> 
...
\<comment>\<open>in 'TestV2ITypesStructured' (TestV2ITypesStructured.vdmsl) at line 17:5\<close>
type_synonym TSet = \<open>VDMNat1 VDMSet\<close>
	
\<comment>\<open>VDM source: inv_TSet: (set of (nat1) +> bool)
	inv_TSet(s) ==
(s <> {})\<close>
\<comment>\<open>in 'TestV2ITypesStructured' (TestV2ITypesStructured.vdmsl) at line 18:22\<close>
definition
...
\<comment>\<open>VDM source: eq_TSet: (set of (nat1) * set of (nat1) +> bool)
	eq_TSet(s1, s2) ==
(s1 subset s2)\<close>
\<comment>\<open>in 'TestV2ITypesStructured' (TestV2ITypesStructured.vdmsl) at line 19:9\<close>
definition
...
\<comment>\<open>in 'TestV2ITypesStructured' (TestV2ITypesStructured.vdmsl) at line 20:9\<close>
definition
...
\<comment>\<open>in 'TestV2ITypesStructured' (TestV2ITypesStructured.vdmsl) at line 23:5\<close>
type_synonym TSet2 = \<open>TSet\<close>
	
\<comment>\<open>VDM source: inv_TSet2: (TSet +> bool)
	inv_TSet2(s) ==
((card s) > 10)\<close>
\<comment>\<open>in 'TestV2ITypesStructured' (TestV2ITypesStructured.vdmsl) at line 24:21\<close>
definition
...
\<comment>\<open>in 'TestV2ITypesStructured' (TestV2ITypesStructured.vdmsl) at line 26:5\<close>
...
\<comment>\<open>in 'TestV2ITypesStructured' (TestV2ITypesStructured.vdmsl) at line 28:5\<close>
type_synonym TSet4 = \<open>TSet3 VDMSet\<close>
	
\<comment>\<open>VDM source: inv_TSet4: (set of (TSet3) +> bool)
	inv_TSet4(s) ==
((card s) > 20)\<close>
\<comment>\<open>in 'TestV2ITypesStructured' (TestV2ITypesStructured.vdmsl) at line 29:21\<close>
definition
...
\<comment>\<open>in 'TestV2ITypesStructured' (TestV2ITypesStructured.vdmsl) at line 31:5\<close>
type_synonym TSeq = \<open>VDMNat1 VDMSeq1\<close>
	
\<comment>\<open>VDM source: inv_TSeq: (seq1 of (nat1) +> bool)
	inv_TSeq(s) ==
((card (elems s)) = (len s))\<close>
\<comment>\<open>in 'TestV2ITypesStructured' (TestV2ITypesStructured.vdmsl) at line 32:33\<close>
definition
...
\<comment>\<open>in 'TestV2ITypesStructured' (TestV2ITypesStructured.vdmsl) at line 33:9\<close>
definition
...
\<comment>\<open>VDM source: ord_TSeq: (seq1 of (nat1) * seq1 of (nat1) +> bool)
	ord_TSeq(s1, s2) ==
((len s1) < (len s2))\<close>
\<comment>\<open>in 'TestV2ITypesStructured' (TestV2ITypesStructured.vdmsl) at line 34:9\<close>
definition
...
\<comment>\<open>VDM source: TSeq2 = seq1 of (TSet)
	...
	eq s1 = s2 == ((elems s1) = (elems s2))
	ord s1 < s2 == ((len s1) < (len s2))\<close>
\<comment>\<open>in 'TestV2ITypesStructured' (TestV2ITypesStructured.vdmsl) at line 37:5\<close>
type_synonym TSeq2 = \<open>TSet VDMSeq1\<close>
	
\<comment>\<open>VDM source: inv_TSeq2: (seq1 of (TSet) +> bool)
	inv_TSeq2(s) ==
((card (elems s)) = (len s))\<close>
\<comment>\<open>in 'TestV2ITypesStructured' (TestV2ITypesStructured.vdmsl) at line 38:33\<close>
definition
...
\<comment>\<open>VDM source: eq_TSeq2: (seq1 of (TSet) * seq1 of (TSet) +> bool)
	eq_TSeq2(s1, s2) ==
((elems s1) = (elems s2))\<close>
\<comment>\<open>in 'TestV2ITypesStructured' (TestV2ITypesStructured.vdmsl) at line 39:9\<close>
definition
...
\<comment>\<open>VDM source: ord_TSeq2: (seq1 of (TSet) * seq1 of (TSet) +> bool)
	ord_TSeq2(s1, s2) ==
((len s1) < (len s2))\<close>
\<comment>\<open>in 'TestV2ITypesStructured' (TestV2ITypesStructured.vdmsl) at line 40:9\<close>
definition
...
\<comment>\<open>in 'TestV2ITypesStructured' (TestV2ITypesStructured.vdmsl) at line 43:5\<close>
type_synonym TMap = \<open>(VDMNat1 \<rightharpoonup> VDMNat1)\<close>
	
\<comment>\<open>VDM source: inv_TMap: (map (nat1) to (nat1) +> bool)
	inv_TMap(m) ==
((dom m) <> {})\<close>
\<comment>\<open>in 'TestV2ITypesStructured' (TestV2ITypesStructured.vdmsl) at line 44:20\<close>
definition
...
\<comment>\<open>in 'TestV2ITypesStructured' (TestV2ITypesStructured.vdmsl) at line 45:8\<close>
definition
...
\<comment>\<open>in 'TestV2ITypesStructured' (TestV2ITypesStructured.vdmsl) at line 46:9\<close>
definition
...
lemmas inv_TMap_defs = inv_VDMMap_defs inv_TMap_def inv_VDMNat1_def 


\<comment>\<open>VDM source: TMap2 = map (TSet4) to (TSeq2)\<close>
\<comment>\<open>in 'TestV2ITypesStructured' (TestV2ITypesStructured.vdmsl) at line 52:5\<close>
...
lemmas inv_TMap2_defs = inv_VDMMap_defs inv_TMap2_def inv_TSeq2_def inv_TSet_def inv_TSet3_def inv_TSet4_def inv_VDMNat1_def inv_VDMSeq1'_def inv_VDMSeq1'_defs inv_VDMSet'_def inv_VDMSet'_defs 


\<comment>\<open>VDM source: TMap3 = map (TMap2) to (TMap)\<close>
\<comment>\<open>in 'TestV2ITypesStructured' (TestV2ITypesStructured.vdmsl) at line 54:5\<close>
...
lemmas inv_TMap3_defs = inv_VDMMap_defs inv_TMap_def inv_TMap2_def inv_TMap3_def inv_TSeq2_def inv_TSet_def inv_TSet3_def inv_TSet4_def inv_VDMNat1_def inv_VDMSeq1'_def inv_VDMSeq1'_defs inv_VDMSet'_def inv_VDMSet'_defs 
