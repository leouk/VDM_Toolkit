...
public enum IsaErrorMessage {
    ...
    PLUGIN_UNEXPECTED_ERROR_3P(VDM2IsaError.ISABELLE_E_PLUGIN_BASE + 2,
    ...
    ISA_INVALID_FIELD_UNIONTYPE_2P(VDM2IsaError.ISABELLE_E_ISA_BASE + 33, 
    "Field `%1$s` is an invalid union type: ultimate type is not union type but `%2$s` "), 
    ISA_INVALID_FIELD_UNIONTYPE_INCOMPATIBLE_3P(VDM2IsaError.ISABELLE_E_ISA_BASE + 34, 
    "Field `%1$s` is union type that is not compatible with given argument `%2$s` (with type `%3$s`)."), 
    ISA_INVALID_FIELD_PROJECTION_3P(VDM2IsaError.ISABELLE_E_ISA_BASE + 35, 
    ...
    PO_INVALID_PROOF_STRATEGY_1P(VDM2IsaError.ISABELLE_E_PO_BASE + 4,
