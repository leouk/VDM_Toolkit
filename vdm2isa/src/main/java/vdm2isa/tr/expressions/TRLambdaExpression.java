...
public class TRLambdaExpression extends TRVDMLocalDefinitionListExpression {
    ...
    public String translate() {
        ...
        sb.append(paramPatterns.patternContextTranslate(null));
        sb.append(getFormattingSeparator() + "\t");
    ...
    public static final TRLambdaExpression newLambdaExpression(TRTypeBindList bindList, TRExpression expression)
    {
        ...
        {
            IsabelleCommand.report(IsaErrorMessage.VDMSL_INVALID_EXPR_4P, LexLocation.ANY, "bindings or expression", "synthetic lambda", mbinds.size(), String.valueOf(expression));
