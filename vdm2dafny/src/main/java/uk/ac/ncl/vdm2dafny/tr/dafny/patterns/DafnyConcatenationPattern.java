...
public class DafnyConcatenationPattern implements DafnyPattern {
    private TCConcatenationPattern pattern;

    public DafnyConcatenationPattern(TCConcatenationPattern pattern) {
    ...
    public String translate() {
        return DafnyTemplates.PATTERNS.render("concat", Pair.of("pattern", this));
    }
